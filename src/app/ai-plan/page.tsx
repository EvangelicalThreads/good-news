  ...
  return (
    <div className="luxuryContainer">
      <header className="luxuryHeader">
        ...
        <p className="subHeader">Enter your goal below and receive a gentle, day-by-day plan.</p>
        ...
        <div className="goalInputContainer">
          <input
            ...
            className="goalInput"
          />
          <button onClick={generatePlan} disabled={loadingPlan} className="generateButton">
