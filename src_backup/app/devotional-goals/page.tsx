      ...
      >
        {goals.map((goal: Goal) => {
          ...
          return (
            ...
            >
              <h2 className={`text-2xl font-semibold mb-2 ${isSelected ? "text-green-900" : "text-green-800"}`}>
                {title}
              </h2>
              {description && <p className="text-green-700 text-sm leading-relaxed">{description}</p>}
              ...
              <button
                ...
                aria-label={isSelected ? "Current devotional goal" : `Select ${title} as your devotional goal`}
                tabIndex={-1}
              >
